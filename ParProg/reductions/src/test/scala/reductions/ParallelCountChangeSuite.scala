...
//  }
  ...
  test("parCountChange should work for multi-coins") {
    def check(money: Int, coins: List[Int], expected: Int) =
      assert(parCountChange(money, coins, ParallelCountChange.moneyThreshold(50)) == expected,
        s"countChange($money, $coins) should be $expected")
...
//    val func = ParallelCountChange.moneyThreshold(50)
//    println(func(50, List(1,2,5,10)))
//  }
